...
print("\nFrozen configuration: K=16, beta=1e-3, lambda=0, 10 000 steps, batch 512, N=448 training episodes unless stated, seeds 0-7.  Closed loop = 128 episodes per model in Isaac (means over the evaluated seeds, sufficient or not).")
